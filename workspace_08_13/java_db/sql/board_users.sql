...
select * from users where id='java01' and password='1234';--o

select * from users where id='java01' and password='java01';--x
...
values ((select nvl(max(seq),0)+1 from board), 'sql 더쉽게, 더 깊게', 'create grant select',
'19/02/24', default, 'java02');
